...
from rl.LQAH.test_neural_network import lqah_test_model
...
def parser():
    ...
    parser.add_argument('--seed', type=int, default=0,
                        help="Random seed")
    parser.add_argument('-w', '--weight_1', type=str, default='./BL.zip',
                        help='trained weight path')
    parser.add_argument('-v', '--weight_2', type=str, default='./GA.zip',
                        help='trained weight path')
    parser.add_argument('-y', '--weight_3', type=str, default='./DR.zip',
                        help='trained weight path')
    parser.add_argument('-z', '--weight_4', type=str, default='./OK.zip',
                        help='trained weight path')
    return parser
...
def main():
    ...
    # # Testing mode with a trained weight
        ...
        model_1 = PPO2.load(args.weight_1)
        model_2 = PPO2.load(args.weight_2)
        model_3 = PPO2.load(args.weight_3)
        model_4 = PPO2.load(args.weight_4)
        lqah_test_model(env, model_1, model_2, model_3, model_4, render=args.render)
